"""
Test BTCTrendFollower strategy year by year (2020-2025).

Pure trend following: No prediction, just follow SMA alignment.
Entry: SMA20 > SMA50 > SMA200
...
from strategies.btc_trendfollower import BTCTrendFollower
...
def print_yearly_results(results: list):
    ...
    print("\n" + "="*100)
    print("BTCTrendFollower Strategy - Yearly Performance Analysis (2020-2025)")
    print("="*100)
    ...
    criteria = {
        ...
        'Trades per year 1-5': 1 <= avg_trades_per_year <= 5,
    ...
    print("="*100)
    print(f"V1 Baseline:     50% yearly win rate")
    print(f"V2 Optimized:    33% yearly win rate")
    print(f"BTCAdaptive:     33% yearly win rate")
    print(f"BTCOpportunistic: 17% yearly win rate")
    print(f"BTCTrendFollower: {yearly_win_rate:.0f}% yearly win rate")
    
    if yearly_win_rate > 50:
        print(f"\n🎉 BTCTrendFollower is the BEST approach so far!")
    elif yearly_win_rate == 50:
        print(f"\n✅ BTCTrendFollower matches V1 baseline")
    else:
        print(f"\n❌ BTCTrendFollower still worse than V1 baseline")
...
def main():
    ...
    print("\nTesting BTCTrendFollower strategy year by year...")
    print("Strategy: Pure trend following (SMA20 > SMA50 > SMA200)")
    print("-"*100)
